...
pub fn folder(sz: u32) -> Element {
    stroke(sz, "1.7", rsx! { path { d: "M3 7a2 2 0 0 1 2-2h4l2 2h6a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" } })
}
...
pub fn search(sz: u32) -> Element {
    stroke(sz, "1.8", rsx! { circle { cx: "11", cy: "11", r: "7" } path { d: "m20 20-3.5-3.5" } })
}
...
pub fn clock(sz: u32) -> Element {
    stroke(sz, "1.7", rsx! { circle { cx: "12", cy: "12", r: "9" } path { d: "M12 7v5l3 2" } })
}
...
pub fn sliders(sz: u32) -> Element {
    stroke(sz, "1.7", rsx! { path { d: "M4 21v-7M4 10V3M12 21v-9M12 8V3M20 21v-5M20 12V3M1 14h6M9 8h6M17 16h6" } })
}
...
pub fn info(sz: u32) -> Element {
    stroke(sz, "1.7", rsx! { circle { cx: "12", cy: "12", r: "9" } path { d: "M12 11v5" } path { d: "M12 7.6v.01" } })
}
pub fn download(sz: u32) -> Element {
    stroke(sz, "1.7", rsx! { path { d: "M12 3v12M8 11l4 4 4-4M5 21h14" } })
}
pub fn eye(sz: u32) -> Element {
    stroke(sz, "1.7", rsx! { path { d: "M2 12s3.5-7 10-7 10 7 10 7-3.5 7-10 7S2 12 2 12z" } circle { cx: "12", cy: "12", r: "2.5" } })
}
pub fn pencil(sz: u32) -> Element {
    stroke(sz, "1.8", rsx! { path { d: "M12 20h9M16.5 3.5a2.1 2.1 0 0 1 3 3L7 19l-4 1 1-4z" } })
}
...
pub fn collapse_left(sz: u32) -> Element {
    stroke(sz, "1.9", rsx! { path { d: "m11 7-5 5 5 5M18 7l-5 5 5 5" } })
}
pub fn expand_right(sz: u32) -> Element {
    stroke(sz, "1.9", rsx! { path { d: "m13 7 5 5-5 5M6 7l5 5-5 5" } })
}
pub fn branch(sz: u32) -> Element {
    stroke(sz, "1.9", rsx! { path { d: "M6 3v12a3 3 0 0 0 3 3h9M6 9h12" } })
}
pub fn check(sz: u32) -> Element {
    stroke(sz, "2", rsx! { path { d: "M20 6 9 17l-5-5" } })
}
pub fn alert(sz: u32) -> Element {
    stroke(sz, "2", rsx! { path { d: "M12 9v4M12 17h.01M10.3 3.9 1.8 18a2 2 0 0 0 1.7 3h17a2 2 0 0 0 1.7-3L13.7 3.9a2 2 0 0 0-3.4 0z" } })
}
pub fn table(sz: u32) -> Element {
    stroke(sz, "1.7", rsx! { rect { x: "3", y: "4", width: "18", height: "16", rx: "2" } path { d: "M3 9h18M3 14h18M9 4v16" } })
}
/// Filled-outline circle with an exclamation — the results-pane error banner.
pub fn err_circle(sz: u32) -> Element {
    stroke(sz, "1.9", rsx! { circle { cx: "12", cy: "12", r: "9" } path { d: "M12 8v5M12 16h.01" } })
}
/// Three horizontal rules with a divider — the "no results yet" empty state.
pub fn rows(sz: u32) -> Element {
    stroke(sz, "1.6", rsx! { path { d: "M3 5h18M3 12h18M3 19h18" } path { d: "M9 5v14" } })
}
