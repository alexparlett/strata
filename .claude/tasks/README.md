...
| 4 · Multi-window | launcher · settings · export · config modal · native close · **write resiliency** | 🟡 **spine + launcher + open path + session persistence + export done**; the remaining settings categories / config modal remain, and **P4-15 (`.strata` write resiliency) wants pulling before them** → `phase-4-multi-window/` |
