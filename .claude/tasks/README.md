...
| 3 · Catalog + inspector + drawer | sidebar/catalog · column inspector + profiling · bottom drawer | 🟡 **shell + header + catalog sidebar built** (P3-01 · P3-15 · P3-02 · P3-03 re-scan · P3-04 validity · P3-05 drop confirm); inspector + drawer still empty → `phase-3-catalog-inspector-drawer/` |
