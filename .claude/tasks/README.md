...
| 3 · Catalog + inspector + drawer | sidebar/catalog · column inspector + profiling · bottom drawer | 🟡 **shell + header + catalog sidebar + inspector built** (P3-01 · P3-15 · P3-02 · P3-03 re-scan · P3-04 validity · P3-05 drop confirm · P3-06 row menus · P3-08 inspector · P3-09 profiling · P3-10 cost confirm); drawer still a shell → `phase-3-catalog-inspector-drawer/` |
| 4 · Multi-window | launcher · settings · export · config modal · native close · **write resiliency** | 🟡 **spine + launcher + open path + session persistence done**; settings / export / config modal remain, and **P4-15 (`.strata` write resiliency) wants pulling before them** → `phase-4-multi-window/` |
