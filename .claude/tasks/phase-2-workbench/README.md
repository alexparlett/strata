...
- **Plumbing: done (P2-01 + P2-02 + P2-03).** Editor → Run/Explain/Analyze press → engine facade →
  ...
  sort)`-keyed queries. Remaining plumbing is per-surface: plan rendering (P2-05); column sort
  landed with P2-13.
...
| P2-24 | Record view — large nested cells (bounded previews) | 🟡 | — | P2-10, P2-12 |
| P2-25 | Nested-value tree (the cell view's inspector) | ⬜ | — | P2-24 |
