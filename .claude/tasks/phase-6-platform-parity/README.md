...
key cap the Keymap grid now draws too. What remains is the native menu decision, the platform seam,
and the final parity sweep before deleting `crates/strata-dioxus`.
