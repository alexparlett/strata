...
pub(super) fn register_component_themes(th: &mut Theme, typo: &Typography) {
    ...
    th.set(
        ...
        CommandPaletteThemePreference {
            ...
            icon_color: role(Role::TextDim),
            sub_color: role(Role::TextDim),
            esc_color: role(Role::TextDim),
    ...
    th.set(
        ...
        DataGridThemePreference {
            ...
            gutter_color: role(Role::TextDim),
            null_color: role(Role::TextDim),
