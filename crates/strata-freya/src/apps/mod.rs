...
//!
//! Phase 4 adds the `launcher`, `settings`, `export` and `configure`; `connections` lands with
//! its workstream (§6). Spawning and focusing between them is `crate::platform::windows`.
