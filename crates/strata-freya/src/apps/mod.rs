...
//!
//! Phase 4 adds the `launcher`, `settings`, `export` and `configure`; the `connection` editor
//! lands with the Connections workstream (W7 · 03). Spawning and focusing between them is
