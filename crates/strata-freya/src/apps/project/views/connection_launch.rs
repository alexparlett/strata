...
impl Component for ConnectionLauncher {
    fn render(&self) -> impl IntoElement {
        ...
        use_side_effect(move || {
            // Taken, not read-and-left: the slot is a request, and clearing it here is what makes
            // a second press of the same item a second request rather than a no-op.
        ...
        // Nothing to draw: `open_connection` is a window, not an overlay.
        rect()
    }
}
