...
use crate::engine::{fold_ident, registered_function};
...
mod tests {
    ...
    use crate::engine::sql::{complete, Catalog, CompletionKind};
    use crate::engine::{Engine, RunOutcome, RunTag, StatementReport, StoreEffect, WsId};
