...
pub fn save() {
    ...
    let updated = crate::project::upsert_saved_query(name.clone(), sql, meta);
...
pub fn delete_saved(name: &str) {
    crate::project::remove_saved_query(name);
